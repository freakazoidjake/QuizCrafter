...
struct QuizBrain {
    ...
    mutating func checkAnswer(_ userAnswer: String?) -> Bool {
        let didPlayerScore = userAnswer?.lowercased() == quiz[questionNumber].correctAnswer.lowercased()
    ...
    mutating func nextQuestion() {
        guard questionNumber < quiz.count - 1 else {
            questionNumber = 0
            playerScore = 0
            return
        }
